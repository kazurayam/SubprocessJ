...
I wanted to automate this command line operation in my Java code. So I developed a Java class link:../src/main/java/com/kazurayam/subprocessj/ProcessKiller.java[`com.kazurayam.subprocessj.ProcessTerminator`].
